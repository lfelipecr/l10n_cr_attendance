odoo.define('l10n_cr_attendance.my_attendances', function (require) {
"use strict";
                ...
                if (result.action) {
                     $.getJSON('https://api.ipify.org?format=json', function(data){
                            ...
                            var def = self._rpc({
                                model: 'hr.attendance',
                                method: 'get_dir_ip',
                                args: [[result.action.attendance],[data.ip]],
                            })
                            .then(function (res) {
                                console.log(res)
    ...
    get_ip: function(action){
        ...
        $.getJSON('https://api.ipify.org?format=json', function(data){
            ...
            var def = self._rpc({
                model: 'hr.attendance',
                method: 'get_dir_ip',
                args: [[action.attendance],[data.ip]],
            })
            .then(function (res) {
                console.log(res)
